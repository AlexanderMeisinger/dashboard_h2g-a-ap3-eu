...
if (display == "Scenario comparison") and (number_sensitivities <= 1):
    ...
    ds = xr.open_dataset("data/scenarios-test-overnight1.nc")
    ...
    plot = df.hvplot.bar(stacked=True, height=720, ylim=ylim, line_width=0, ylabel=choices[idx]).opts(fontscale=1.3, tools=[hover])
